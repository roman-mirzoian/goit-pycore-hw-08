...
from api.commands import add_birthday, add_contact, change_contact, delete_contact, get_birthdays, remove_phone, show_all, show_birthday, show_phone
    ...
    try:
        while True:
            ...
            if command == "hello":
                ...
                log_answer(remove_phone(args, book))
            elif command == "all":
